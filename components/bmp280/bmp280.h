...
#define BMP280_CHIP_ID  0x58 //!< BMP280 has chip-id 0x58 (Pressure, Temperature)
#define BME280_CHIP_ID  0x60 //!< BME280 has chip-id 0x60 (Pressure, Temperature, Humidity)
...
/**
 * Initialize forced default parameters.
 * Default configuration:
 *      mode: FORCED
 *      filter: OFF
 *      oversampling: x4
 *      standby time: 1000ms
 */
esp_err_t bmp280_init_forced_default_params(bmp280_params_t *params);
